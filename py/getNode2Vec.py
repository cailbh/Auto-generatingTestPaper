...
with open(inputDir, "r", encoding="utf-8") as f:
    content = json.load(f)
    for rel in content:  # problems:
        edges.append([str("kp_"+rel['conceptId']), str("pro_"+rel['problemId'])])
...
# FILES
EMBEDDING_FILENAME = "problems_ConceptGPTRel_vector.txt"
EMBEDDING_MODEL_FILENAME = 'problems_ConceptGPTRel_embeddings.model'
INPUTEDGE_FILENAME = "problems_ConceptGPTRel.txt"
